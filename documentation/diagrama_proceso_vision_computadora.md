# Diagrama de Procesos: Funcionamiento del Hardware en Visor por Computadora para Adquisición de Imágenes
...
└─────────────────┘    └─────────────────┘    └─────────────────┘
         ...
         ▼                       ▼                       ▼
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│ CAPTURA DE LUZ  │    │ TRANSMISIÓN     │    │ RECEPCIÓN Y     │
│                 │    │ DE DATOS        │    │ PROCESAMIENTO   │
│ • Conversión    │    │                 │    │                 │
│   fotónica      │    │ • Protocolo     │    │ • Decodificación│
│ • Digitalización│    │   RTSP          │    │ • Buffer de     │
│ • Compresión    │    │ • Stream H.264  │    │   frames        │
│   H.264/JPEG   │    │ • Latencia      │    │ • Procesamiento │
└─────────────────┘    └─────────────────┘    └─────────────────┘
```
...
Este diagrama ilustra cómo el hardware trabaja en conjunto para proporcionar un sistema de visión por computadora robusto y eficiente para la adquisición de imágenes desde múltiples cámaras RTSP en tiempo real.
